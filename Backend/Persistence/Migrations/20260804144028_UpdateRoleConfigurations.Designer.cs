...
namespace Persistence.Migrations
{
    ...
    [Migration("20260804144028_UpdateRoleConfigurations")]
    partial class UpdateRoleConfigurations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ApplicationMenus.ApplicationMenu", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsShowOnMobile")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("Domain.Entities.Roles.RolePermission", b =>
                {
                    ...
                    b.HasIndex("RoleId", "ApplicationMenuId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.UserSessions.UserSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Users.User", b =>
                {
                    ...
                    b.Property<DateTime?>("MfaLockedUntilUtc")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Domain.Entities.ApplicationMenus.ApplicationMenu", b =>
                {
                    b.HasOne("Domain.Entities.ApplicationMenus.ApplicationMenu", "ParentMenu")
                        .WithMany("ChildMenus")
            ...
            modelBuilder.Entity("Domain.Entities.Roles.RolePermission", b =>
                {
                    b.HasOne("Domain.Entities.ApplicationMenus.ApplicationMenu", "ApplicationMenu")
                        .WithMany()
