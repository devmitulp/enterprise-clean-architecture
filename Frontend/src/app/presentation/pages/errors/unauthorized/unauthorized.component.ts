  ...
  template: `
    <div class="flex min-h-screen flex-col justify-center items-center px-6 py-12 bg-slate-50 dark:bg-slate-950">
      <div class="text-center">
        <p class="text-base font-semibold text-rose-600 dark:text-rose-400">403</p>
        <h1 class="mt-4 text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-5xl">Access Denied</h1>
        <p class="mt-6 text-base leading-7 text-slate-600 dark:text-slate-400">You do not have the required permissions to view this resource.</p>
